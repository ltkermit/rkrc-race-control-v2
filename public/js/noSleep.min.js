      ...
      i = function () {
        function A() {
          ...
          if (
            ...
            this._wakeLock = null;
            var B = function () {
              null !== e._wakeLock && "visible" === document.visibilityState &&
                e.enable();
            };
            ...
            return Q()
              ? navigator.wakeLock.request("screen").then(function (e) {
                A._wakeLock = e,
                  ...
                  A._wakeLock.addEventListener("release", function () {
              ...
              ? (this.disable(),
                ...
                this.enabled = !0,
                Promise.resolve())
              : this.noSleepVideo.play().then(function (e) {
            ...
            Q()
              ...
              ? this.noSleepTimer &&
                (console.warn(
                  ...
                  this.noSleepTimer = null)
              : this.noSleepVideo.pause(), this.enabled = !1;
          },
        }, {
          key: "isEnabled",
          get: function () {
